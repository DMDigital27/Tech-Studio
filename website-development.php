...
<head>
    ...
    <!-- Page Title -->
    <title>Website Development Company in Ahmedabad | DM Tech Studio</title>

    <!-- Meta Tags -->
    <meta name="description" content="Build a stunning, SEO-friendly website with DM Tech Studio in Prahladnagar, Ahmedabad. We create websites that grow your business.">
    ...
    <link rel="canonical" href="https://dmtechstudio.com/website-development.php" />
    ...
    <meta property="og:title" content="Website Development Company in Ahmedabad | DM Tech Studio ">
...
"@context": "http://schema.org",
    ...
    "provider": {
        "@type": "Organization",
        "name": "DM Tech Studio",
        "additionalType": "https://www.wikidata.org/wiki/Q1323528",
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "Sun Gravitas, 1139-1140, Rajmani Society, Shyamal, Ahmedabad, Gujarat",
            "postalCode": "380015",
            "addressRegion": "IN",
            "addressLocality": "India",
            "addressCountry": "https://www.wikidata.org/wiki/Q668",
            "name": "Postal Address",
            "@id": "https://dmtechstudio.com//#PostalAddress"
        },
 "description": "Grow your business with DM Tech Studio in Prahladnagar, Ahmedabad. Expert in SEO, Social Media, PPC, and Website Development..",
        "@id": "https://dmtechstudio.com/"
    },
"image": {
        "@type": "ImageObject",
        "url": "https://dmtechstudio.com/assets/img/illustrations/1200x1200_service-image-01.webp",
        "height": "800",
        "width": "1920"
    },
"brand": {
...
"additionalType": "https://www.wikidata.org/wiki/Q113535609",
    "url": "https://dmtechstudio.com/website-development.php",
    "areaServed": "https://www.wikidata.org/wiki/Q1070",
    "description": "Build a stunning, SEO-friendly website with DM Tech Studio in Prahladnagar, Ahmedabad. We create websites that grow your business.",
    "name": "Always on-trend creatives",
    "@id": "https://dmtechstudio.com/website-development.php"
}
</script>
...
<body>
    ...
    <main id="mxd-page-content" class="mxd-page-content">
        ...
        <!-- Hero Section Start -->
        <div class="mxd-section mxd-hero-section padding-grid-pre-mtext">
            <div class="mxd-hero-03">
                <div class="mxd-hero-03__wrap loading-wrap">
                    <!-- top part -->
                    <div class="mxd-hero-03__top">
                        <!-- marquee -->
                        <div class="mxd-hero-03__marquee loading__item">
                            <!-- Marquee Start -->
                            <div class="marquee marquee-right--gsap">
                                <div class="marquee__toright">
                                    <!-- item -->
                                    <div class="marquee__item one-line">
                                        <div class="hero-03-marquee__video">
                                            <video preload="auto" autoplay="autoplay" loop="loop" muted="muted" poster="video/hero/hero-video-02.webp">
                                                <source type="video/mp4" src="assets/video/hero/hero-video-02.mp4">
                                                <source type="video/webm" src="assets/video/hero/hero-video-02.webm">
                                                <source type="video/ogv" src="assets/video/hero/hero-video-02.ogv">
                                            </video>
                                        </div>
                                    </div>
                                    <!-- item -->
                                    <div class="marquee__item one-line">
                                        <div class="hero-03-marquee__image">
                                            <img class="mxd-move" src="assets/img/hero/29_hero-img.webp" alt="Image">
                                        </div>
                                    </div>
                                    <!-- item -->
                                    <div class="marquee__item one-line">
                                        <div class="hero-03-marquee__video">
                                            <video preload="auto" autoplay="autoplay" loop="loop" muted="muted" poster="video/hero/hero-video-01.webp">
                                                <source type="video/mp4" src="video/hero/hero-video-01.mp4">
                                                <source type="video/webm" src="video/hero/hero-video-01.webm">
                                                <source type="video/ogv" src="video/hero/hero-video-01.ogv">
                                            </video>
                                        </div>
                                    </div>
                                    <!-- item -->
                                    <div class="marquee__item one-line">
                                        <div class="hero-03-marquee__image">
                                            <img class="mxd-rotate-slow" src="assets/img/hero/28_hero-img.webp" alt="Image">
                                        </div>
                                    </div>
                                    <!-- item -->
                                    <div class="marquee__item one-line">
                                        <div class="hero-03-marquee__image">
                                            <img class="mxd-move" src="assets/img/hero/30_hero-img.webp" alt="Image">
                                        </div>
                                    </div>
                                    <!-- item -->
                                    <div class="marquee__item one-line">
                                        <div class="hero-03-marquee__image">
                                            <img class="mxd-pulse-small" src="assets/img/hero/24_hero-img.webp" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mxd-hero-03__headline">
                            <p class="hero-03-headline__caption loading__item">Cutting-edge<br>Website development<br>company in Ahmedabad</p>
                            <h1 class="hero-03-headline__title loading__item">
                                <span class="hero-03-headline__hidden">DM Digital</span>
                                <svg class="hero-03-headline__svg-mobile" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        ...
                        <div class="mxd-container">
                            ...
                            <div class="mxd-divider">
                                <div class="mxd-divider__video">
                                    <video class="video parallax-video" preload="auto" autoplay="autoplay" loop="loop" muted="muted" poster="video/1920x1080_video-04.webp">
                                        <source type="video/mp4" src="assets/video/1920x1080_video-04.mp4">
                                        <source type="video/webm" src="assets/video/1920x1080_video-04.webm">
                                        <source type="video/ogv" src="assets/video/1920x1080_video-04.ogv">
                                    </video>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row gx-0">
                            <div class="col-12 col-xl-5 mxd-grid-item no-margin">
                                <div class="mxd-block__name">
                                    <h2 class="reveal-type anim-uni-in-up">Always on-trend creatives</h2>
                                </div>
                            </div>
                            <div class="col-12 col-xl-6 mxd-grid-item no-margin">
                                <div class="mxd-block__content">
                                    <div class="mxd-block__paragraph">
                                        <p class="t-large t-bright anim-uni-in-up">At DM Tech Studio in Ahmedabad, our expert web developers create customized websites that perfectly balance performance, usability, and stunning design, helping your brand stand out online.</p>
                                         <p class="t-large t-bright anim-uni-in-up"> We enhance your online presence and craft innovative digital experiences. Our solutions align with your vision and are designed to drive measurable success and growth for your business.</p>
                                            ...
                                            <div class="container-fluid p-0">
                                                <div class="row g-0">
                                                    <div class="col-6 col-xl-5">
                                                        <ul>
                                                            <li>
                                                                <p class="anim-uni-in-up">Online Retail Systems</p>
                                                            </li>
                                                            <li>
                                                                <p class="anim-uni-in-up">Web Content Platforms</p>
                                                            </li>
                                                            <li>
                                                                <p class="anim-uni-in-up">User Interface & Experience Design</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-6 col-xl-5">
                                                        <ul>
                                                            <li>
                                                                <p class="anim-uni-in-up">Adaptive Web Layouts</p>
                                                            </li>
                                                            <li>
                                                                <p class="anim-uni-in-up">Site Care & Assistance</p>
                                                            </li>
                                                            <li>
                                                                <p class="anim-uni-in-up">Tailored Web Development</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mxd-paragraph__controls anim-uni-in-up">
                                            <a class="btn btn-anim btn-default btn-outline slide-right-up" href="contact.php">
                                                <span class="btn-caption">Let's Meet Closer</span>
                                ...
                                <div class="col-12 col-xl-8 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in-right">
                                    <div class="mxd-services-cards-s__inner justify-between bg-base-tint radius-l padding-4">
                                        <div class="mxd-services-cards-s__title">
                                            <h3 class="anim-uni-in-up">Digital Retail
<br>solutions</h3>
                                        </div>
                                        <div class="mxd-services-cards-s__info width-50">
                                            <div class="mxd-services-cards-s__tags">
                                                ...
                                                <span class="tag tag-default tag-outline anim-uni-in-up">Packaging</span>
                                                <span class="tag tag-default tag-outline anim-uni-in-up">Motion</span>
                                                <span class="tag tag-default tag-outline anim-uni-in-up">3D models</span>
                                            </div>
                                            <p class="anim-uni-in-up">At DM Tech Studio in Ahmedabad, we help your business stay competitive in the evolving digital marketplace. Let us elevate your online presence and unlock new growth opportunities to drive success for your brand.</p>
                                        </div>
                                        <div class="mxd-services-cards-s__image image-right">
                                            <img src="assets/img/illustrations/1200x1200_service-image-01.webp" alt="Illustration">
                                        </div>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-xl-4 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in-left">
                                    <div class="mxd-services-cards-s__inner justify-end bg-accent radius-l padding-4">
                                        <div class="mxd-services-cards-s__title">
                                            <h3 class="opposite anim-uni-in-up">Dynamic PHP
Web Design</h3>
                                        </div>
                                        <div class="mxd-services-cards-s__info">
                                            <div class="mxd-services-cards-s__tags">
                                                <span class="tag tag-default tag-outline-opposite anim-uni-in-up">Frontend</span>
                                                <span class="tag tag-default tag-outline-opposite anim-uni-in-up">Interactions</span>
                                                <span class="tag tag-default tag-outline-opposite anim-uni-in-up">Backend</span>
                                            </div>
                                            <p class="t-opposite anim-uni-in-up">Our Dynamic PHP Web Design at DM Tech Studio in Ahmedabad ensures your website stands out with enhanced performance, robust security, and interactive, adaptable features that engage users and drive results.</p>
                                        </div>
                                        <div class="mxd-services-cards-s__image image-top-right">
                                            <img class="mxd-move" src="assets/img/illustrations/1200x1200_service-image-02.webp" alt="Illustration">
                                        </div>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-xl-4 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in-right">
                                    <div class="mxd-services-cards-s__inner bg-additional radius-l padding-4">
                                        <div class="mxd-services-cards-s__title">
                                            <h3 class="anim-uni-in-up">ASP.Net Site
Engineering</h3>
                                        </div>
                                        <div class="mxd-services-cards-s__info">
                                            <div class="mxd-services-cards-s__tags">
                                                <span class="tag tag-default tag-outline anim-uni-in-up">Strategy</span>
                                                <span class="tag tag-default tag-outline anim-uni-in-up">Social media</span>
                                                <span class="tag tag-default tag-outline anim-uni-in-up">SEO</span>
                                            </div>
                                            <p class="t-bright anim-uni-in-up">ASP.Net Site Engineering in Ahmedabad – Innovative, secure, and scalable websites that elevate your online presence.</p>
                                        </div>
                                        <div class="mxd-services-cards-s__image image-bottom">
                                            <img class="mxd-rotate-slow" src="assets/img/illustrations/1200x1200_service-image-03.webp" alt="Illustration">
                                        </div>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-xl-4 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in">
                                    <div class="mxd-services-cards-s__inner bg-base-opp radius-l padding-4">
                                        <div class="mxd-services-cards-s__title">
                                            <h3 class="opposite anim-uni-in-up">Dynamic Python
programming</h3>
                                        </div>
                                        <div class="mxd-services-cards-s__info">
                                            <div class="mxd-services-cards-s__tags">
                                            ...
                                            <p class="t-opposite anim-uni-in-up">Dynamic Python Programming in Ahmedabad – Cutting-edge, versatile solutions tailored to drive your business success.</p>
                                        </div>
                                        <div class="mxd-services-cards-s__image image-bottom image-bottom-2">
                                            <img src="assets/img/illustrations/1200x1200_service-image-04.webp" alt="Illustration">
                                        </div>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-xl-4 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in-left">
                                    <div class="mxd-services-cards-s__inner justify-end bg-base-tint radius-l padding-4">
                                        <div class="mxd-services-cards-s__title">
                                            <h3 class="anim-uni-in-up">Cloud Integration Services</h3>
                                        </div>
                                        <div class="mxd-services-cards-s__info">
                                            <div class="mxd-services-cards-s__tags">
                                                <span class="tag tag-default tag-outline anim-uni-in-up">E-Commerce</span>
                                                <span class="tag tag-default tag-outline anim-uni-in-up">Maintenance</span>
                                                <span class="tag tag-default tag-outline anim-uni-in-up">Support</span>
                                            </div>
                                            <p class="anim-uni-in-up">Connect Applications & Data in Ahmedabad – Streamline operations for efficiency, scalability, and smarter business growth.</p>
                                        </div>
                                        <div class="mxd-services-cards-s__image image-top">
                                            <img src="assets/img/illustrations/1200x1200_service-image-05.webp" alt="Illustration">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="mxd-section padding-pre-title">
            <div class="mxd-container">
                <div class="mxd-divider">
                    <div class="mxd-divider__image divider-image-5 parallax-img"></div>
                </div>
            </div>
        </div>
                      ...
                      <p class="anim-uni-in-up">Mastership</p>
                                ...
                                <div class="col-12 col-xl-3 mxd-grid-item no-margin">
                                    <div class="mxd-section-title__hrcontrols anim-uni-in-up">
                                        <a class="btn btn-anim btn-default btn-outline slide-right-up" href="#">
                                            <span class="btn-caption">All Services</span>
                                            <i class="ph-bold ph-arrow-up-right"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="mxd-cpb-list">
                                    ...
                                    <div class="mxd-cpb-list__item hover-reveal__item">
                                        ...
                                        <div class="hover-reveal__content hover-reveal-280x340">
                                            <img class="hover-reveal__image" src="assets/img/illustrations/600x730_cpb-01.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__content anim-uni-in-up">
                                            <h6 class="mxd-cpb-list__title">Core Development</h6>
                                            <div class="mxd-cpb-list__num">
                                                <span>/ 01</span>
                                            </div>
                                        </div>
                                        <div class="mxd-cpb-list__image anim-uni-in-up">
                                            <img src="assets/img/illustrations/1200x800_cpb-01.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                    </div>
                                    <!-- item -->
                                    <div class="mxd-cpb-list__item hover-reveal__item">
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                        <div class="hover-reveal__content hover-reveal-280x340">
                                            <img class="hover-reveal__image" src="assets/img/illustrations/600x730_cpb-03.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__content anim-uni-in-up">
                                            <h6 class="mxd-cpb-list__title">Design & Experience</h6>
                                            <div class="mxd-cpb-list__num">
                                                <span>/ 02</span>
                                            </div>
                                        </div>
                                        <div class="mxd-cpb-list__image anim-uni-in-up">
                                            <img src="assets/img/illustrations/1200x800_cpb-03.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                    </div>
                                    <!-- item -->
                                    <div class="mxd-cpb-list__item hover-reveal__item">
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                        <div class="hover-reveal__content hover-reveal-280x340">
                                            <img class="hover-reveal__image" src="assets/img/illustrations/600x730_cpb-02.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__content anim-uni-in-up">
                                            <h6 class="mxd-cpb-list__title">Performance & Tech</h6>
                                            <div class="mxd-cpb-list__num">
                                                <span>/ 03</span>
                                            </div>
                                        </div>
                                        <div class="mxd-cpb-list__image anim-uni-in-up">
                                            <img src="assets/img/illustrations/1200x800_cpb-02.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                    </div>
                                    <!-- item -->
                                    <div class="mxd-cpb-list__item hover-reveal__item">
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                        <div class="hover-reveal__content hover-reveal-280x340">
                                            <img class="hover-reveal__image" src="assets/img/illustrations/600x730_cpb-04.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__content anim-uni-in-up">
                                            <h6 class="mxd-cpb-list__title">Maintenance & Support</h6>
                                            <div class="mxd-cpb-list__num">
                                                <span>/ 04</span>
                                            </div>
                                        </div>
                                        <div class="mxd-cpb-list__image anim-uni-in-up">
                                            <img src="assets/img/illustrations/1200x800_cpb-04.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                    </div>
                                    <!-- item -->
                                    <div class="mxd-cpb-list__item hover-reveal__item">
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                        <div class="hover-reveal__content hover-reveal-280x340">
                                            <img class="hover-reveal__image" src="assets/img/illustrations/600x730_cpb-05.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__content anim-uni-in-up">
                                            <h6 class="mxd-cpb-list__title">Software testing</h6>
                                            <div class="mxd-cpb-list__num">
                                                <span>/ 05</span>
                                            </div>
                                        </div>
                                        <div class="mxd-cpb-list__image anim-uni-in-up">
                                            <img src="assets/img/illustrations/1200x800_cpb-05.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                    </div>
                                    <!-- item -->
                                    <div class="mxd-cpb-list__item hover-reveal__item">
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                        <div class="hover-reveal__content hover-reveal-280x340">
                                            <img class="hover-reveal__image" src="assets/img/illustrations/600x730_cpb-06.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__content anim-uni-in-up">
                                            <h6 class="mxd-cpb-list__title">Generative AI development</h6>
                                            <div class="mxd-cpb-list__num">
                                                <span>/ 06</span>
                                            </div>
                                        </div>
                                        <div class="mxd-cpb-list__image anim-uni-in-up">
                                            <img src="assets/img/illustrations/1200x800_cpb-06.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                    </div>
                                    <!-- item -->
                                    <div class="mxd-cpb-list__item hover-reveal__item">
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                        <div class="hover-reveal__content hover-reveal-280x340">
                                            <img class="hover-reveal__image" src="assets/img/illustrations/600x730_cpb-07.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__content anim-uni-in-up">
                                            <h6 class="mxd-cpb-list__title">SEO-Friendly Development</h6>
                                            <div class="mxd-cpb-list__num">
                                                <span>/ 07</span>
                                            </div>
                                        </div>
                                        <div class="mxd-cpb-list__image anim-uni-in-up">
                                            <img src="assets/img/illustrations/1200x800_cpb-07.webp" alt="Project Preview">
                                        </div>
                                        <div class="mxd-cpb-list__divider anim-uni-in-up"></div>
                                    </div>
                                </div>
        ...
        <div class="mxd-section padding-pre-grid mobile-grid-title">
            <div class="mxd-container grid-container">
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-12 mxd-grid-item no-margin">
                                                        <div class="mxd-section-title__title">
                                                            <h2 class="reveal-type">Case studies</h2>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mxd-grid-item no-margin">
                                ...
                                <div class="col-12 col-xl-7 mxd-pinned-projects__scroll">
                                    <div class="mxd-pinned-projects__scroll-inner mxd-grid-item no-margin">
                                        ...
                                        <div class="mxd-project-item">
                                            <a class="mxd-project-item__media anim-uni-in-up" href="#">
                                                ...
                                                <div class="mxd-project-item__tags">
                                                    ...
                                                    <span class="tag tag-default tag-permanent">Innovation</span>
                                                    <span class="tag tag-default tag-permanent">Credibility</span>
                                                </div>
                                            </a>
                                            <div class="mxd-project-item__promo">
                                                <div class="mxd-project-item__name">
                                                    <a class="anim-uni-in-up" href="#"><span>Revamping Digital Identity</span> A Modern Corporate Website Overhaul</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- item -->
                                        <div class="mxd-project-item">
                                            <a class="mxd-project-item__media anim-uni-in-up" href="#">
                                                ...
                                                <div class="mxd-project-item__tags">
                                                    <span class="tag tag-default tag-permanent">Sales</span>
                                                    <span class="tag tag-default tag-permanent">Performance</span>
                                                    <span class="tag tag-default tag-permanent">Growth</span>
                                                </div>
                                            </a>
                                            <div class="mxd-project-item__promo">
                                                <div class="mxd-project-item__name">
                                                    <a class="anim-uni-in-up" href="#"><span>Boosting Conversions</span> E-Commerce Store Rebuilt for Sales Growth</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- item -->
                                        <div class="mxd-project-item">
                                            <a class="mxd-project-item__media" href="#">
                                                <div class="mxd-project-item__preview preview-image-3 parallax-img-small"></div>
                                                <div class="mxd-project-item__tags">
                                                    <span class="tag tag-default tag-permanent">Usability</span>
                                                    <span class="tag tag-default tag-permanent">Engagement</span>
                                                    <span class="tag tag-default tag-permanent">Simplicity</span>
                                                </div>
                                            </a>
                                            <div class="mxd-project-item__promo">
                                                <div class="mxd-project-item__name">
                                                    <a href="#"><span>Smart UX, Strong Results</span> Redesigning a Service-Based Website</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- item -->
                                        <div class="mxd-project-item">
                                            <a class="mxd-project-item__media anim-uni-in-up" href="#">
                                                ...
                                                <div class="mxd-project-item__tags">
                                                    <span class="tag tag-default tag-permanent">Speed</span>
                                                    <span class="tag tag-default tag-permanent">Scalability</span>
                                                      <span class="tag tag-default tag-permanent">Reliability</span>
                                                </div>
                                            </a>
                                            <div class="mxd-project-item__promo">
                                                <div class="mxd-project-item__name">
                                                    <a class="anim-uni-in-up" href="#"><span>Scaling for Success</span> A High-Performance Web App Transformation</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- item -->
                                        <div class="mxd-project-item">
                                            <a class="mxd-project-item__media anim-uni-in-up" href="#">
                                                ...
                                                <div class="mxd-project-item__tags">
                                                    <span class="tag tag-default tag-permanent">Global</span>
                                                    <span class="tag tag-default tag-permanent">Expansion</span>
                                                    <span class="tag tag-default tag-permanent">Visibility</span>
                                                </div>
                                            </a>
                                            <div class="mxd-project-item__promo">
                                                <div class="mxd-project-item__name">
                                                    <a class="anim-uni-in-up" href="#"><span>From Local to Global</span> Crafting a Website for International Reach</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mxd-section-title pre-grid no-margin-desktop">
                                    <div class="container-fluid p-0">
                                        <div class="row g-0">
                                            <div class="col-12">
                                                <div class="mxd-section-title__title">
                                                    <h2 class="reveal-type">Our tech<br>stack:</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/01_angular.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                                        <p class="t-bright t-caption">Angular</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- item -->
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/02_react.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                            ...
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/03_vue.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                                        <p class="t-bright t-caption">Vue.js</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- item -->
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/04_php.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                                        <p class="t-bright t-caption">PHP</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- item -->
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/05_c-sharp.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                                        <p class="t-bright t-caption">C#</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- item -->
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/06_javascript.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                                        <p class="t-bright t-caption">JS</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- item -->
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/07_android.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                                        <p class="t-bright t-caption">Android</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- item -->
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/08_ios.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                                        <p class="t-bright t-caption">iOS</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- item -->
                                            <div class="col-12 col-md-6 col-xxl-4 mxd-tech-stack-cards__item mxd-grid-item animate-card-3">
                                                <div class="mxd-tech-stack-cards__inner">
                                                    <div class="mxd-tech-stack-cards__logo">
                                                        ...
                                                        <!-- <img class="inject-me" src="assets/img/tech/09_net.svg" alt="Tech Stack Logo"> -->
                                                    </div>
                                                    <div class="mxd-tech-stack-cards__title">
                                                        <p class="t-bright t-caption">.NET</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-12 col-lg-3 mxd-stats-simple__item mxd-grid-item">
                                    <div class="mxd-stats-simple__inner animate-card-4">
                                        ...
                                        <div class="mxd-counter">
                                            <p id="stats-counter-1" class="mxd-stats-number mxd-stats-simple__counter">0</p>
                                        </div>
                                        <!-- image -->
                                        <img class="mxd-stats-simple__image" src="assets/img/icons/h70_stats-01.webp" alt="Icon">
                                        <!-- description -->
                                        <p class="mxd-stats-simple__descr t-140 t-bright">Happy clients who<br>trust our work</p>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-lg-3 mxd-stats-simple__item mxd-grid-item">
                                    <div class="mxd-stats-simple__inner animate-card-4">
                                        <!-- counter -->
                                        <div class="mxd-counter">
                                            <p id="stats-counter-2" class="mxd-stats-number mxd-stats-simple__counter">0</p>
                                        </div>
                                        <!-- image -->
                                        <img class="mxd-stats-simple__image" src="assets/img/icons/h70_stats-02.webp" alt="Icon">
                                        <!-- description -->
                                        <p class="mxd-stats-simple__descr t-140 t-bright">Awards
...
<br>achievement</p>
                                ...
                                <div class="col-12 col-lg-3 mxd-stats-simple__item mxd-grid-item">
                                    <div class="mxd-stats-simple__inner animate-card-4">
                                        <!-- counter -->
                                        <div class="mxd-counter">
                                            <p id="stats-counter-3" class="mxd-stats-number mxd-stats-simple__counter">0</p>
                                        </div>
                                        <!-- image -->
                                        <img class="mxd-stats-simple__image" src="assets/img/icons/h70_stats-03.webp" alt="Icon">
                                        <!-- description -->
                                        <p class="mxd-stats-simple__descr t-140 t-bright">Years of professional<br>experience</p>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-lg-3 mxd-stats-simple__item mxd-grid-item">
                                    <div class="mxd-stats-simple__inner animate-card-4">
                                        <!-- counter -->
                                        <div class="mxd-counter">
                                            <p id="stats-counter-4" class="mxd-stats-number mxd-stats-simple__counter">0</p>
                                        </div>
                                        <!-- image -->
                                        <img class="mxd-stats-simple__image" src="assets/img/icons/h70_stats-04.webp" alt="Icon">
                                        <!-- description -->
                                        <p class="mxd-stats-simple__descr t-140 t-bright">Successfully<br>completed projects</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--BLOG SLIDER End-->>
    ...
    <!-- To Top Button Start -->
    <a href="#top" id="to-top" class="btn btn-round btn-to-top slide-up anim-no-delay">
    ...
    <script>
        ...
        const statsCounter2 = new countUp.CountUp("stats-counter-2", 8, optionsPlus);
